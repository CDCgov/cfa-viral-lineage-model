...
- a Python package `linmod` for downloading lineage count data, and fitting and evaluating models with this data; and
- `retrospective-forecasting/`, with code that uses this package to automate the retrospective evaluation of models.

To run the evaluation: `cd retrospective-forecasting && uv run ./run_all.sh`.
